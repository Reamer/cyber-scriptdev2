...
struct MANGOS_DLL_DECL boss_malacrassAI : public ScriptedAI
{
	...
	uint32 m_uiSpell_SPIRIT_BOLTS_Timer; 
    uint32 m_uiSPELL_SIPHON_SOUL_Timer;
    uint32 m_uiSPELL_DRAIN_POWER_Timer;

    uint32 m_uiSPELL_CLASS;
	
    uint32 m_uiSPELL_DRAINED_1_Timer;
    uint32 m_uiSPELL_DRAINED_2_Timer;
    uint32 m_uiSPELL_DRAINED_3_Timer;
    ...
    void Reset()
    {
		...
		m_uiSpell_SPIRIT_BOLTS_Timer = 10000;

        m_uiSPELL_DRAIN_POWER_Timer = 9800;
        
        m_uiSPELL_SIPHON_SOUL_Timer = 20000;
    ...
    void UpdateAI(const uint32 uiDiff)
    {
		...
		if (m_uiSpell_SPIRIT_BOLTS_Timer < uiDiff)
            {
			    DoCastSpellIfCan(m_creature->getVictim(),SPELL_SPIRIT_BOLTS);
             
                m_uiSpell_SPIRIT_BOLTS_Timer = 40000;   
				
            }
		else
                m_uiSpell_SPIRIT_BOLTS_Timer -= uiDiff;


		if (m_uiSPELL_DRAIN_POWER_Timer < uiDiff)
		{
             m_uiSPELL_CLASS = 0;
             m_creature->CastSpell(m_creature->getVictim(),SPELL_DRAIN_POWER,true);
             m_uiSPELL_DRAIN_POWER_Timer = 40000;
		}
        else 
            m_uiSPELL_DRAIN_POWER_Timer -= uiDiff;
		

	    if (m_uiSPELL_SIPHON_SOUL_Timer < uiDiff )
		{
			Unit* pTarget = m_creature->SelectAttackingTarget(ATTACKING_TARGET_RANDOM, 0);
               
            m_creature->CastSpell(pTarget,SPELL_SIPHON_SOUL, true);

            m_uiSPELL_CLASS = pTarget->getClass();

            m_uiSPELL_SIPHON_SOUL_Timer = 40000;


            switch(m_uiSPELL_CLASS)
            {
            case CLASS_PRIEST:
                m_uiSPELL_DRAINED_1_Timer = 1000;
                m_uiSPELL_DRAINED_2_Timer = 5000;
                m_uiSPELL_DRAINED_3_Timer = 8000;
                break;
            case CLASS_PALADIN:

                m_uiSPELL_DRAINED_1_Timer = 3000;
                m_uiSPELL_DRAINED_2_Timer = 1000;

                break;
            case CLASS_WARLOCK:
                m_uiSPELL_DRAINED_1_Timer = 10000;
                m_uiSPELL_DRAINED_2_Timer = 8000;
                m_uiSPELL_DRAINED_3_Timer = 1000;
                break;
            case CLASS_MAGE:
                m_uiSPELL_DRAINED_1_Timer = 1000;
                m_uiSPELL_DRAINED_2_Timer = 5000;
                m_uiSPELL_DRAINED_3_Timer = 9000;
                break;
            case CLASS_ROGUE:
                m_uiSPELL_DRAINED_1_Timer = 3000;
                m_uiSPELL_DRAINED_2_Timer = 7000;
                m_uiSPELL_DRAINED_3_Timer = 1000;
                break;
            case CLASS_WARRIOR:
                m_uiSPELL_DRAINED_1_Timer = 4000;
                m_uiSPELL_DRAINED_2_Timer = 2000;
                break;
            case CLASS_DRUID:
                m_uiSPELL_DRAINED_1_Timer = 9000;
                m_uiSPELL_DRAINED_2_Timer = 5000;
                 m_uiSPELL_DRAINED_3_Timer = 1000;
                break;
            case CLASS_SHAMAN:
                m_uiSPELL_DRAINED_1_Timer = 12000;
                m_uiSPELL_DRAINED_2_Timer = 7000;
                m_uiSPELL_DRAINED_3_Timer = 2000;
                break;
            case CLASS_HUNTER:
                m_uiSPELL_DRAINED_1_Timer = 3000;
                m_uiSPELL_DRAINED_2_Timer = 7000;
            ...
            m_uiSPELL_SIPHON_SOUL_Timer -= uiDiff;
            ...
            {
            case CLASS_PRIEST:
                if(m_uiSPELL_DRAINED_1_Timer < uiDiff){
                    
                    m_creature->CastSpell(m_creature,SPELL_PR_HEAL, false);

                    m_uiSPELL_DRAINED_1_Timer = 10000;
                }
                else
                    m_uiSPELL_DRAINED_1_Timer -=uiDiff;



                if(m_uiSPELL_DRAINED_2_Timer < uiDiff){
                    
                    m_creature->CastSpell(m_creature->getVictim(),SPELL_PR_PSYCHIC_SCREAM, false);

                    m_uiSPELL_DRAINED_2_Timer = 10000;
                }
                else
                    m_uiSPELL_DRAINED_2_Timer -=uiDiff;



                if(m_uiSPELL_DRAINED_3_Timer < uiDiff){
                    
                    Unit* pTarget = m_creature->SelectAttackingTarget(ATTACKING_TARGET_RANDOM, 0);
                    
                    m_creature->CastSpell(pTarget,SPELL_PR_MIND_BLAST, false);
                    m_uiSPELL_DRAINED_3_Timer = 10000;
                }
                else
                    m_uiSPELL_DRAINED_3_Timer -=uiDiff;
            ...
            case CLASS_PALADIN:
                if(m_uiSPELL_DRAINED_1_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(m_creature,SPELL_PA_HOLY_LIGHT, false);
                    m_uiSPELL_DRAINED_1_Timer = 10000;
                }
                else
                    m_uiSPELL_DRAINED_1_Timer -=uiDiff;
                ...
                if(m_uiSPELL_DRAINED_2_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(m_creature->getVictim(),SPELL_PA_CONSECRATION, false);
                    m_uiSPELL_DRAINED_2_Timer = 100000;
                }
                else
                    m_uiSPELL_DRAINED_2_Timer -=uiDiff;
                ...
                if(m_uiSPELL_DRAINED_3_Timer < uiDiff){
                    ...
                    m_uiSPELL_DRAINED_3_Timer = 200000;
                }
                else
                    m_uiSPELL_DRAINED_3_Timer -=uiDiff;
            ...
            case CLASS_WARLOCK:
                if(m_uiSPELL_DRAINED_1_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(pTarget,SPELL_WL_CURSE_OF_DOOM, false);

                    m_uiSPELL_DRAINED_1_Timer = 70000;
                }
                else
                    m_uiSPELL_DRAINED_1_Timer -=uiDiff;
                ...
                if(m_uiSPELL_DRAINED_2_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(pTarget,SPELL_WL_UNSTABLE_AFFL, false);

                    m_uiSPELL_DRAINED_2_Timer = 9000;
                }
                else
                    m_uiSPELL_DRAINED_2_Timer -=uiDiff;
                ...
                if(m_uiSPELL_DRAINED_3_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(pTarget,SPELL_WL_RAIN_OF_FIRE, false);
                    
                    m_uiSPELL_DRAINED_3_Timer = 11000;
                }
                else
                    m_uiSPELL_DRAINED_3_Timer -=uiDiff;
            ...
            case CLASS_MAGE:
                if(m_uiSPELL_DRAINED_1_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(pTarget,SPELL_MG_FROSTBOLT, false);

                    m_uiSPELL_DRAINED_1_Timer = 6000;
                }
                else
                    m_uiSPELL_DRAINED_1_Timer -=uiDiff;
                ...
                if(m_uiSPELL_DRAINED_2_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(pTarget,SPELL_MG_FIREBALL, false);
                    
                    m_uiSPELL_DRAINED_2_Timer = 6000;
                }
                else
                    m_uiSPELL_DRAINED_2_Timer -=uiDiff;
                ...
                if(m_uiSPELL_DRAINED_3_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(m_creature->getVictim(),SPELL_MG_FROST_NOVA, false);
            ...
            case CLASS_ROGUE:
                if(m_uiSPELL_DRAINED_1_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(m_creature,SPELL_RO_SLICE_DICE, false);

                    m_uiSPELL_DRAINED_1_Timer = 7000;
                }
                else
                    m_uiSPELL_DRAINED_1_Timer -=uiDiff;
                ...
                if(m_uiSPELL_DRAINED_2_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(pTarget,SPELL_RO_BLIND, false);
                ...
                if(m_uiSPELL_DRAINED_3_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(m_creature,SPELL_RO_WOUND_POISON, false);
                    
                    m_uiSPELL_DRAINED_3_Timer = 70000;
                }
                else
                    m_uiSPELL_DRAINED_3_Timer -=uiDiff;
            ...
            case CLASS_WARRIOR:
                if(m_uiSPELL_DRAINED_1_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(m_creature,SPELL_WR_WHIRLWIND, false);
                ...
                if(m_uiSPELL_DRAINED_2_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(m_creature,SPELL_WR_SPELL_REFLECT, false);
            ...
            case CLASS_DRUID:
                if(m_uiSPELL_DRAINED_1_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(m_creature,SPELL_DR_LIFEBLOOM, false);
                ...
                if(m_uiSPELL_DRAINED_2_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(pTarget,SPELL_DR_MOONFIRE, false);
                ...
                if(m_uiSPELL_DRAINED_3_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(m_creature,SPELL_DR_THORNS, false);
            ...
            case CLASS_SHAMAN:
                if(m_uiSPELL_DRAINED_1_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(m_creature,SPELL_SH_FIRE_NOVA, false);
                ...
                if(m_uiSPELL_DRAINED_2_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(m_creature,SPELL_SH_HEALING_WAVE, false);
                ...
                if(m_uiSPELL_DRAINED_3_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(pTarget,SPELL_SH_CHAIN_LIGHT, false);
                    
                    m_uiSPELL_DRAINED_3_Timer = 7000;
                }
                else
                    m_uiSPELL_DRAINED_3_Timer -=uiDiff;
            ...
            case CLASS_HUNTER:
                if(m_uiSPELL_DRAINED_1_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(pTarget,SPELL_HU_EXPLOSIVE_TRAP, false);
                ...
                if(m_uiSPELL_DRAINED_2_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(pTarget,SPELL_HU_FREEZING_TRAP, false);
                ...
                if(m_uiSPELL_DRAINED_3_Timer < uiDiff){
                    ...
                    m_creature->CastSpell(pTarget,SPELL_HU_SNAKE_TRAP, false);
...
struct MANGOS_DLL_DECL mob_darkheartAI : public boss_malacrass_addAI
{
    ...
    void UpdateAI(const uint32 uiDiff)
    {
        ...
        if (m_uiPsychicWailTimer < uiDiff)
        {
            ...
            {
                m_creature->CastSpell(m_creature->getVictim(), SPELL_PSYCHIC_WAIL,true);
