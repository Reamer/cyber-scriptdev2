...
case 1251:// Shadowfang Keep
    if (player->getLevel() >= 14)
    {
        ...
        player->CLOSE_GOSSIP_MENU();
        _Creature->MonsterSay("You must be at least level 14!", LANG_UNIVERSAL);
    }
break;
...
case 1254:// Razorfen Kraul
    if (player->getLevel() >= 17)
    {
        ...
        player->CLOSE_GOSSIP_MENU();
        _Creature->MonsterSay("You must be at least level 17!", LANG_UNIVERSAL);
    }
break;
